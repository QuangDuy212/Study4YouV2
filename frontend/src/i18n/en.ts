export const en = {
  ...
  partAudioFor: "Audio for all of {part}",
  addImageOptional: "Add Image (Optional)",
  passagePlaceholder: "Enter the passage text...",
  questionPlaceholderListening: "Enter the question or transcript...",
  questionPlaceholderReading: "Enter the sentence with ____ blank...",
  optionPlaceholder: "Option {label}",
  sharedPassage: "Shared Passage",
  enterSharedPassage: "Enter shared passage for this question set...",
  ...
  audioSizeLimit: "Audio must be smaller than 10MB!",
  invalidImageFormat: "You can only upload JPG/PNG/WEBP file!",
  imageSizeLimit: "Image must be smaller than 10MB!",
